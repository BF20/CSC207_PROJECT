...
//        FileUserDataAccessObject usernames = new FileUserDataAccessObject();
//        Map<String, User> users = usernames.get_all_users();
        ...
        try {
            for (String username : usernames) {
                ...
                String jsFilePath = jsFilesDirectory + username + "_habit_hours.js";
